				...
				<form id="form2" name="form2" method="post">
					<table width="100%" class="table2">
						<tbody id="id">
							...
							<tr>
								<th>아이디</th>
								<td><input name="id" tpye="text" value="${yjhlist.id}"
									class="tbox01" /></td>
							</tr>
							<tr>
								<th>비밀번호</th>
								<td><input name="pw" tpye="text" value="${yjhlist.pw}"
									class="tbox01" /></td>
							</tr>
							<tr>
								<th>이름</th>
								<td><input name="user_name" tpye="text"
									value="${yjhlist.user_name}" class="tbox01" /></td>
							</tr>
							<tr>
								<th>제목</th>
								<td><input name="title" tpye="text"
									value="${yjhlist.title}" class="tbox01" /></td>
							</tr>
							<tr>
								<th>내용</th>
								<td><input tpye="text" name="board_context"
									value="${yjhlist.board_context}" cols="10" row="5"
									class="textarea01"></td>
							</tr>
						</tbody>
					</table>
